...
PaymentRequest.prototype.putPayment = async function (id, created_at, payment) {
  const dynamo = new AWS.DynamoDB.DocumentClient(dynamoConfig())

  console.log("Put payment start");
  console.log("id",id,"created_at",created_at,"payment",payment);
