...
PaymentRequest.prototype.index = async function (id) {
  ...
  try {
    ...
    Logger.error(['Error in DynamoDB scan: ',error]);
...
PaymentRequest.prototype.get = async function (id, created_at) {
  ...
  try {
    ...
    Logger.error(['Error in DynamoDB get: ',error]);
    throw new Error(error);
  }
}
...
PaymentRequest.prototype.put = async function (record) {
  ...
  try {
    ...
    Logger.error(['Error in DynamoDB put: ',error]);
    throw new Error(error)
  }
}
...
PaymentRequest.prototype.recordPayment = async function (id, created_at, payment) {
  ...
  try {
    ...
    Logger.error(['Error in DynamoDB recordPayment: ',error]);
    throw new Error(error);
  }
}
...
PaymentRequest.prototype.upsertRecord = async function (payment) {
  const dynamo = new AWS.DynamoDB.DocumentClient(dynamoConfig())
  ...
  try {
    ...
    Logger.error(['Error in DynamoDB putPayment: ',error]);
    throw new Error(error);
  }
}
