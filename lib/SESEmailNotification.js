const template    = require('./TemplateRenderer')
...
SESEmailNotification.prototype.sendEmail =
  async function (templateName, templateParameters) {
    ...
    var bodyText = await template.render("emails/" + templateName + ".txt", templateParameters)
    // The email body for recipients with non-HTML email clients.
    var bodyHtml = await template.render("emails/" + templateName + ".html", templateParameters)
