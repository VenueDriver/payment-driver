...
async function rejectIfPaid(event, context) {
  ...
  if(paymentRequest.payment && paymentRequest.payment.captured){
    return new Response('200').send(
      await template.render('error', { 'error': 'This payment request is no longer available, please contact support at <a href="mailto:support@venuedriver.com">support@hakkasan.com</a>.' }))
  }
